...
We set =org-num-face= to a non-nil value so that the digits at the start of org-mode headings have their own font (rather than the one of the rest of the heading).
