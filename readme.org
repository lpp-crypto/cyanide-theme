...
#+BEGIN_SRC python :var space=0 :var color="tan" :var background_hl=0 :var height=1.0 :var weight="normal" :noweb yes :results output :tangle no
  print(
      "((t (:background \"{}\" :foreground \"{}\" :height {} :weight {} :box (:line-width ({} . {}) :color \"{}\"))))".format(
          "#bdad99" if background_hl else "<<std-background>>",
          color,
          height,
          weight,
          space,
...
#+BEGIN_SRC emacs-lisp  
'(outline-1 <<outline-heading-template(color="black", height=1.7, weight="extra-bold", space=10, background_hl=1)>>)
'(outline-2 <<outline-heading-template(color="#a14821", height=1.5, weight="bold", space=10)>>)
'(outline-3 <<outline-heading-template(color="#653c29", height=1.2, weight="semi-bold", space=6)>>)
'(outline-4 <<outline-heading-template(color="#513428", height=1.05, weight="semi-bold", space=3)>>)
'(outline-5 <<outline-heading-template(color="#513428", height=1.0, weight="semi-bold", space=2)>>)
#+END_SRC 
...
#+BEGIN_SRC emacs-lisp 
'(org-document-title ((t (:background "<<structure-color>>" :foreground "<<structure-background>>" :height 2.0 :weight semi-bold))))
